...
"}")
        ...
        self.lb_logo.setPixmap(QPixmap(u":/Icon/Resources/Icons/wave_packet_bg.png"))
        ...
        self.verticalLayout.addWidget(self.lb_text)
...
"")
        ...
        self.verticalLayout_4.addWidget(self.frm_1)
